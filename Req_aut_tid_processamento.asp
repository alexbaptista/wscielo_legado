...
mensagem = "<?xml version='1.0' encoding='ISO-8859-1'?><requisicao-autorizacao-tid id='2' versao='1.1.1'><tid>" & tid & "</tid><dados-ec><numero>" & numero & "</numero><chave>" & chave & "</chave></dados-ec></requisicao-autorizacao-tid>"
%>
...
<tr>
	...
	<br />
	<h2 align="center">Ops ! Esta página somente poderá ser acessada, após o processamento da autorização via TID</h2>
	<h2 align="center"><a href="Req_aut_tid.asp" class="linkfundobranco">Voltar</a></h2>
</body>
<%
Else
	...
	function gravaXml(dado,titulo)
		...
		Set d = fs.CreateTextFile(Server.MapPath("Xml\Requisicao-autorizacao-tid-retorno\" & Session("usuario") &  "-" & titulo  & ".xml"),true)
...
<tr>
	...
	<br />
		<table cellspacing="5" align="center" width="576">
			<tr>
				<td height="50" colspan="3" align="center" class="topo">RETORNO AUTORIZAÇÃO-TID | ERRO</td>
			</tr>
			<tr height="50">
				<td align="center" width="30%" class="menu">Detalhes:</td>
				<td align="center" class="submenugrande" colspan="2"><a href="Download.asp?arquivo=Xml/Requisicao-autorizacao-tid-retorno/<%= Session("usuario") %>-<%= NameXMLerro %>.xml" >Download XML</a></td>
			</tr>
			<tr height="50">
				<td align="center" height="50" class="menu">Código:</td>
				<td align="center" height="50" class="submenugrande" colspan="2"><%= raiz.childNodes.item(0).childNodes.item(0).text%></td>
			</tr>
			<tr height="50">
				<td align="center" height="50" class="menu">Mensagem:</td>
				<td align="center" height="50" class="submenugrande" colspan="2"><%= raiz.childNodes.item(1).childNodes.item(0).text%></td>
			</tr>
			<tr>
...
<tr>
	...
	<br />
		<table cellspacing="5" align="center" width="576">
			<tr>
				<td height="50" colspan="3" align="center" class="topo">RETORNO AUTORIZAÇÃO-TID</td>
			</tr>
			<tr>
				<td align="center" class="menu" width="30%">Detalhes:</td>
				<td align="center" class="submenu" colspan="2"><a href="Download.asp?arquivo=Xml/Requisicao-autorizacao-tid-retorno/<%= Session("usuario") %>-<%= tid %>.xml" >Download XML</a></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td height="50" align="center" width="50%" class="topo"><input type="button" value="Captura" OnClick=window.location.href="Req_captura.asp" id="button"/></td>
				<td height="50" align="center" width="50%" class="topo"><input type="button" value="Cancelamento" OnClick=window.location.href="Req_cancel.asp" id="button"/></td>
			</tr>
		</table>
        </body>
		<%
