...
mensagem = "<?xml version='1.0' encoding='ISO-8859-1'?><requisicao-tid id='6' versao='1.1.1'><dados-ec><numero>" & numero & "</numero><chave>" & chave & "</chave></dados-ec><forma-pagamento><bandeira>" & bandeira & "</bandeira><produto>" & produto & "</produto><parcelas>" & parcelas & "</parcelas></forma-pagamento></requisicao-tid>"
%>
	...
	<br />
		<table cellspacing="5" align="center" width="576">
			...
			<tr>
				...
				<td height="50" align="center" class="topo" colspan="2"><input type="button" value="Autorização direta portador" OnClick=window.location.href="Req_aut_dir_portador1.asp" id="button2" /></td>
			</tr>
		</table>
        </body>
		<%
