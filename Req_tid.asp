...
<tr>
	...
	<table cellspacing="5" align="center" width="576">
		...
		<tr>
			...
			<form name="requisicao_tid" action="Req_tid_processamento.asp" method="post">
    ...
    <table cellspacing="5" align="center" width="576">
        ...
        <tr>
            ...
            <td class="submenu" onMouseOver="this.className='menu_light';doTooltip(event,8.1)" onMouseOut="this.className='submenu';hideTip()">Bandeira:</td><td align="center" class="menu" colspan="2"><br /><input type="radio" id="0" checked="checked" name="forma_pagamento_bandeira" value="visa" /><img src="Imagens/Visa_2.png" align="middle"/>
