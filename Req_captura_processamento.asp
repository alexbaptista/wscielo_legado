...
valor = Request.Form("dados_ec_valor")
anexo = Request.Form("dados_ec_anexo")

mensagem = "<?xml version='1.0' encoding='ISO-8859-1'?><requisicao-captura id='3' versao='1.1.1'><tid>" & tid & "</tid><dados-ec><numero>" & numero & "</numero><chave>" & chave & "</chave></dados-ec><valor>" & valor & "</valor><anexo>" & anexo & "</anexo></requisicao-captura>"
%>
...
<tr>
	...
	<br />
	<h2 align="center">Ops ! Esta página somente poderá ser acessada, após o processamento da captura</h2>
	<h2 align="center"><a href="Req_captura.asp" class="linkfundobranco">Voltar</a></h2>
</body>
<%
Else
	...
	function gravaXml(dado,titulo)
		...
		Set d = fs.CreateTextFile(Server.MapPath("Xml\Requisicao-captura-retorno\" & Session("usuario") &  "-" & titulo  & ".xml"),true)
...
<tr>
	...
	<br />
		<table cellspacing="5" align="center" width="576">
			<tr>
				<td height="50" colspan="3" align="center" class="topo">RETORNO CAPTURA | ERRO</td>
			</tr>
			<tr height="50">
				<td align="center" width="30%" class="menu">Detalhes:</td>
				<td align="center" class="submenugrande" colspan="2"><a href="Download.asp?arquivo=Xml/Requisicao-captura-retorno/<%= Session("usuario") %>-<%= NameXMLerro %>.xml">Download XML</a></td>
			</tr>
			<tr height="50">
...
<tr>
	...
	<br />
		<table cellspacing="5" align="center" width="576">
			<tr>
				<td height="50" colspan="3" align="center" class="topo">RETORNO CAPTURA</td>
			</tr>
			<tr>
				<td align="center" class="menu" width="30%">Detalhes:</td>
				<td align="center" class="submenu" colspan="2"><a href="Download.asp?arquivo=Xml/Requisicao-captura-retorno/<%= Session("usuario") %>-<%= tid %>.xml">Download XML</a></td>
			</tr>
			<tr>
			...
			<tr>	
				...
				<td height="50" align="center" class="topo" colspan="2"><input type="button" value="Cancelamento" OnClick=window.location.href="Req_cancel.asp" id="button"/></td>	
			</tr>
		</table>
        </body>
		<%
