...
<tr>
	...
	<br />
	<form name="requisicao_autorizacao_tid" action="Req_aut_tid_processamento.asp" method="post">
	<table cellspacing="5" align="center" width="576">
    	<tr>
        	<td height="50" colspan="3" align="center" class="topo">CONFIGURAÇÃO DO AMBIENTE</td>
		</tr>
		<tr>
			<td align="center" height="50" class="menu" width="30%" onMouseOver="this.className='menu_light';doTooltip(event,3)" onMouseOut="this.className='menu';hideTip()">AMBIENTE</td>
		...
		<tr>
			...
			<td height="50" align="center" class="topo" colspan="2"><input type="button" value="Limpar formulário" OnClick="limpar_formulario2()" id="button"/></td>	
        </tr>
	</table>
	<br />
	<br />
	<table cellspacing="5" align="center" width="576">
    	<tr>
        	<td height="50" colspan="4" align="center" class="topo" onMouseOver="this.className='menu_light';doTooltip(event,14)" onMouseOut="this.className='topo';hideTip()">REQUISIÇÃO-AUTORIZAÇÃO-TID</td>
		</tr>
		<tr>
			...
			<td class="menu" colspan="2"><input type="text" name="tid" value="<%= Session("TEMPtid")%>" size="20" maxlength="30"/></td>
        </tr>
    	<tr>
        ...
        <tr>
         	<td height="50" colspan="4" align="center" class="topo"><input type="submit" value="Confirmar dados" OnClick="return valida2()" id="button"/></td>
        </tr>
	</table>
	</form>
</body>
