...
If Session("login") = "suporteweb" and Session("password") = "passw0rd" Then
	...
	If Session("TEMPambiente") <> "" and Session("TEMPbypage") <> "" and Session("TEMPnumero") <> "" and Session("TEMPchave") <> "" Then
		...
		DPsoftdescriptor = Request.Form("dados_pedido_softdescriptor")
...
<tr>
	...
	<table align="center" cellspacing="5" width="576">
        ...
        <tr>
        <td rowspan="7" align="center" class="menu">DADOS-PEDIDO</td>
            <td class="submenu">Número:</td>
        ...
        <tr>
        	<td class="submenu">Soft Descriptor:</td>
			<td align="center"><input type="text" size="30" readonly="readonly" value="<%= DPsoftdescriptor %>" /></td>
        </tr>
        <tr>
        <td rowspan="3" align="center" class="menu">FORMA-PAGAMENTO</td>
		<td class="submenu">Bandeira:</td>
			<td align="center">
			<% If FPbandeira = "visa" Then %>
			<img src="Imagens/Visa_2.png" align="middle"/>
			<% Elseif FPbandeira = "mastercard" Then %>
			<img src="Imagens/Mastercard_2.png" align="middle"/>
			<% Elseif FPbandeira = "elo" Then %>
			<img src="Imagens/Elo_2.png" align="middle"/>
			<% Elseif FPbandeira = "diners" Then %>
			<img src="Imagens/Diners_2.png" align="middle"/>
			<% Elseif FPbandeira = "discover" Then %>
			<img src="Imagens/Discover_2.png" align="middle"/>
			<% Elseif FPbandeira = "amex" Then %>
			<img src="Imagens/Amex_2.png" align="middle"/>
			<% End If %>
		</td>
        </tr>
        <tr>
        ...
        <tr>
         ...
         <tr height="50">
			...
			<td align="center" class="topo"><input type="text" readonly="readonly" size="20" value="<%= XML_req_trans_loja %>" /></td>
         	<form name="transacao_requisicao_cielo" action="Req_trans_processamento23.asp" method="post"><input type="hidden" name="ambiente" value="<%= CBPambiente %>" /><input type="hidden" name="mensagem" value="<%= XML_req_trans_loja %>" /><input type="hidden" name="bypage" value="<%= Bpage %>" />
...
<% Elseif Bpage = "Cielo" Then %>
        ...
        <tr>
         ...
         <tr height="50">
			...
			<form name="transacao_requisicao_cielo" action="Req_trans_processamento23.asp" method="post" ><input type="hidden" name="mensagem" value="<%= XML_req_trans_cielo %>" /><input type="hidden" name="ambiente" value="<%= CBPambiente %>" /><input type="hidden" name="bypage" value="<%= Bpage %>" />
			<td align="center" class="topo"><input type="submit" value="Enviar ?" id="button"/></td>
		 	</form>
         </tr>
    </table>
...
<tr>
	...
	<br />
		...
		<h2 align="center"><a href="Req_trans2.asp" class="linkfundobranco">Voltar</a></h2>
	</body>
<%
End If
Else
