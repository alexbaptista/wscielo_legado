...
<tr>
	...
	<table align="center" cellspacing="5" width="576">
        ...
        <tr>
			...
			<td align="center"><% If FPbandeira = "visa" Then %><img src="Imagens/Visa_2.png" align="middle"/><% Elseif FPbandeira = "mastercard" Then %><img src="Imagens/Mastercard_2.png" align="middle"/><% Elseif FPbandeira = "elo" Then %><img src="Imagens/Elo_2.png" align="middle"/><% Elseif FPbandeira = "diners" Then %><img src="Imagens/Diners_2.png" align="middle"/><% Elseif FPbandeira = "discover" Then %><img src="Imagens/Discover_2.png" align="middle"/><% End If %></td>
        </tr>
        <tr>
        ...
        <tr>
         ...
         <tr height="50">
			...
			<td align="center" class="topo"><input type="text" readonly="readonly" size="20" value="<%= XML_req_trans_loja %>" /></td>
         	<form name="transacao_requisicao_cielo" action="Req_trans_processamento22.asp" method="post"><input type="hidden" name="ambiente" value="<%= CBPambiente %>" /><input type="hidden" name="mensagem" value="<%= XML_req_trans_loja %>" /><input type="hidden" name="bypage" value="<%= Bpage %>" />
...
<% Elseif Bpage = "Cielo" Then %>
        ...
        <tr>
         ...
         <tr height="50">
			...
			<form name="transacao_requisicao_cielo" action="Req_trans_processamento22.asp" method="post" ><input type="hidden" name="mensagem" value="<%= XML_req_trans_cielo %>" /><input type="hidden" name="ambiente" value="<%= CBPambiente %>" /><input type="hidden" name="bypage" value="<%= Bpage %>" />
			<td align="center" class="topo"><input type="submit" value="Enviar ?" id="button"/></td>
		 	</form>
         </tr>
    </table>
...
<tr>
	...
	<br />
		...
		<h2 align="center"><a href="Req_trans1.asp" class="linkfundobranco">Voltar</a></h2>
	</body>
<%
End If
Else
