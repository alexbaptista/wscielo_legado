...
<tr>
	...
	<table cellspacing="5" align="center" width="576">
    	...
    	<tr>
        	<td align="center" class="menu" onMouseOver="this.className='menu_light';doTooltip(event,5)" onMouseOut="this.className='menu';hideTip()">VALOR</td>
    		<td class="submenu" onMouseOver="this.className='menu_light';doTooltip(event,5.1)" onMouseOut="this.className='submenu';hideTip()">valor:</td>
		<td class="menu" colspan="2"><input type="text" name="valor" size="12" maxlength="12"/></td>
        </tr>
        <tr>
         	<td height="50" colspan="4" align="center" class="topo"><input type="submit" value="Confirmar dados" OnClick="return valida41()" id="button"/></td>
        </tr>
	</table>
	</form>
</body>
