...
mensagem = "<?xml version='1.0' encoding='ISO-8859-1'?><requisicao-consulta-chsec id='5' versao='1.2.0'><numero-pedido>" & numeropedido & "</numero-pedido><dados-ec><numero>" & numero & "</numero><chave>" & chave & "</chave></dados-ec></requisicao-consulta-chsec>"
%>
...
<tr>
	...
	<br />
	<h2 align="center">Ops ! Esta página somente poderá ser acessada, após o processamento da consulta</h2>
	<h2 align="center"><a href="Req_consulta1.asp" class="linkfundobranco">Voltar</a></h2>
</body>
<%
Else
	...
	function gravaXml(dado,titulo)
		...
		Set d = fs.CreateTextFile(Server.MapPath("Xml\Requisicao-consulta-retorno\" & Session("usuario") &  "-" & titulo  & ".xml"),true)
...
<tr>
	...
	<br />
		<table cellspacing="5" align="center" width="576">
			<tr>
				<td height="50" colspan="3" align="center" class="topo">RETORNO CONSULTA | ERRO</td>
			</tr>
			<tr height="50">
				<td align="center" class="menu" width="30%">Detalhes:</td>
				<td align="center" class="submenugrande" colspan="2"><a href="Download.asp?arquivo=Xml/Requisicao-consulta-retorno/<%= Session("usuario") %>-<%= NameXMLerro %>.xml">Download XML</a></td>
			</tr>
			<tr height="50">
...
<tr>
	...
	<br />
		<table cellspacing="5" align="center" width="576">
			<tr>
				<td height="50" colspan="3" align="center" class="topo">RETORNO CONSULTA</td>
			</tr>
			<tr>
				<td align="center" class="menu" width="30%">Detalhes:</td>
				<td align="center" class="submenu" colspan="2"><a href="Download.asp?arquivo=Xml/Requisicao-consulta-retorno/<%= Session("usuario") %>-<%= tid %>.xml">Download XML</a></td>
			</tr>
			<tr>
				<td align="center" colspan="3" class="menu"><textarea cols="80" rows="18" readonly="readonly"><%= xXml %></textarea></td>
			<tr>
				<td height="50" align="center" class="topo" colspan="3"><input type="button" value="Voltar" OnClick=window.location.href="Default.asp" id="button"/></td>
			</tr>
		</table>
        </body>
		<%
