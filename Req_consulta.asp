...
<tr>
	...
	<br />
	<form name="requisicao_consulta" action="Req_consulta_processamento.asp" method="post">
	...
	<table cellspacing="5" align="center" width="576">
    	<tr>
        	<td height="50" colspan="4" align="center" class="topo" onMouseOver="this.className='menu_light';doTooltip(event,19)" onMouseOut="this.className='topo';hideTip()">REQUISIÇÃO-CONSULTA</td>
		</tr>
		<tr>
    		...
    		<td class="submenu" width="30%" onMouseOver="this.className='menu_light';doTooltip(event,15.1)" onMouseOut="this.className='submenu';hideTip()">TID:</td><td class="menu" colspan="2"><input type="text" name="tid" value="<%= Session("TEMPtid")%>" size="20" maxlength="40"/></td>
        </tr>
    	<tr>
        ...
        <tr>
         	<td height="50" colspan="4" align="center" class="topo"><input type="submit" value="Confirmar dados" OnClick="return valida5()" id="button"/></td>
        </tr>
	</table>
	</form>
</body>
