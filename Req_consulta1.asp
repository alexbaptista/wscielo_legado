...
<tr>
	...
	<br />
	<form name="requisicao_consulta" action="Req_consulta_processamento1.asp" method="post">
	<table cellspacing="5" align="center" width="576">
		...
		<tr>
			...
			<td height="50" align="center" class="topo" colspan="2"><input type="button" value="Limpar formulário" OnClick="limpar_formulario5()" id="button"></td>	
        </tr>
	</table>
	<br />
	<br />
	<table cellspacing="5" align="center" width="576">
    	<tr>
        	<td height="50" colspan="4" align="center" class="topo" onMouseOver="this.className='menu_light';doTooltip(event,19)" onMouseOut="this.className='topo';hideTip()">REQUISIÇÃO-CONSULTA-CHSEC</td>
		</tr>
		<tr>
        	<td align="center" class="menu" width="30%" onMouseOver="this.className='menu_light';doTooltip(event,23)" onMouseOut="this.className='menu';hideTip()">NUMERO-PEDIDO</td>
    		<td class="submenu" width="30%" onMouseOver="this.className='menu_light';doTooltip(event,23.1)" onMouseOut="this.className='submenu';hideTip()">Número:</td><td class="menu" colspan="2"><input type="text" name="numeropedido" size="20" maxlength="20"/></td>
        </tr>
    	<tr>
        ...
        <tr>
         	<td height="50" colspan="4" align="center" class="topo"><input type="submit" value="Confirmar dados" OnClick="return valida51()" id="button"/></td>
        </tr>
	</table>
	</form>
</body>
