...
mensagem = "<?xml version='1.0' encoding='ISO-8859-1'?><requisicao-cancelamento id='4' versao='1.2.0'><tid>" & tid & "</tid><dados-ec><numero>" & numero & "</numero><chave>" & chave & "</chave></dados-ec><valor>" & valor & "</valor></requisicao-cancelamento>"
%>
...
<tr>
	...
	<br />
	<h2 align="center">Ops ! Esta página somente poderá ser acessada, após o processamento do cancelamento</h2>
	<h2 align="center"><a href="Req_cancel1.asp" class="linkfundobranco">Voltar</a></h2>
</body>
<%
Else
	...
	function gravaXml(dado,titulo)
		...
		Set d = fs.CreateTextFile(Server.MapPath("Xml\Requisicao-cancelamento-retorno\" & Session("usuario") &  "-" & titulo  & ".xml"),true)
...
<tr>
	...
	<br />
		<table cellspacing="5" align="center" width="576">
			<tr>
				<td height="50" colspan="3" align="center" class="topo">RETORNO CANCELAMENTO | ERRO</td>
			</tr>
			<tr height="50">
				<td align="center" class="menu" width="30%">Detalhes:</td>
				<td align="center" class="submenugrande" colspan="2"><a href="Download.asp?arquivo=Xml/Requisicao-cancelamento-retorno/<%= Session("usuario") %>-<%= NameXMLerro %>.xml" >Download XML</a></td>
			</tr>
			<tr height="50">
...
<tr>
	...
	<br />
		<table cellspacing="5" align="center" width="576">
			<tr>
				<td height="50" colspan="3" align="center" class="topo">RETORNO CANCELAMENTO</td>
			</tr>
			<tr>
				<td align="center" class="menu" width="30%">Detalhes:</td>
				<td align="center" class="submenu" colspan="2"><a href="Download.asp?arquivo=Xml/Requisicao-cancelamento-retorno/<%= Session("usuario") %>-<%= tid %>.xml">Download XML</a></td>
			</tr>
			<tr>
				<td align="center" colspan="3" class="menu"><textarea cols="80" rows="18" readonly="readonly"><%= xXml %></textarea></td>
			<tr>
				<td height="50" colspan="3" align="center" class="topo"><input type="button" value="Voltar" OnClick=window.location.href="Default.asp" id="button"/></td>
			</tr>
		</table>
        </body>
		<%
