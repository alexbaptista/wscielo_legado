...
<tr>
	...
	<form name="requisicao_transacao" action="Req_trans_processamento1.asp" method="post">
		<tr>
    ...
    <table align="center" width="576" cellspacing="5">
        ...
        <tr>
            ...
            <td class="submenugrande" onMouseOver="this.className='menu_light';doTooltip(event,8.1)" onMouseOut="this.className='submenugrande';hideTip()">Bandeira:</td>
				<td align="center" class="menu" colspan="2"><br />
																...
																<br /><br /><input type="radio" id="4" name="forma_pagamento_bandeira" value="discover" /><img src="Imagens/Discover_2.png" align="middle"/><br /><br /></td>
        </tr>
        <tr>
        ...
        <tr>
         ...
         <tr>
         	<td height="50" colspan="4" align="center" class="topo"><input type="submit" value="Confirmar dados" OnClick="return valida1()"  id="button"/></td>
         </tr>
    </table>
	<br />
	</form>
