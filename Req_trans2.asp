...
'AMEX'
AUTCARDamex = raiz.childNodes.item(2).childNodes.item(8).childNodes.item(0).childNodes.item(0).text
CARDamex = raiz.childNodes.item(2).childNodes.item(8).childNodes.item(1).childNodes.item(0).text
...
<tr>
	...
	<table align="center" width="576" cellspacing="5">
		...
		<tr>
			...
			<td align="center" class="submenu"><input type="button" value="Autenticado" OnClick="preenche_cartao_AUTCARDdiners()" id="button"></td>
		</tr>
		<tr>
        	<td align="center" class="submenu"><input type="button" value="Não Autenticado" OnClick="preenche_cartao_CARDelo()" id="button"></td>
			<td align="center" class="submenu"><input type="button" value="Não Autenticado" OnClick="preenche_cartao_CARDdiners()" id="button"></td>
		</tr>
			<td rowspan="2" align="center"><img src="Imagens/Discover.png" /></td>
			<td align="center" class="submenu"><input type="button" value="Autenticado" OnClick="preenche_cartao_AUTCARDdiscover()" id="button"></td>
			<td rowspan="2" align="center"><img src="Imagens/Amex.png" /></td>
			<td align="center" class="submenu"><input type="button" value="Autenticado" OnClick="preenche_cartao_AUTCARDamex()" id="button"></td>
		</tr>
		<tr>
			<td align="center" class="submenu"><input type="button" value="Não Autenticado" OnClick="preenche_cartao_CARDdiscover()" id="button"></td>
			<td align="center" class="submenu"><input type="button" value="Não Autenticado" OnClick="preenche_cartao_CARDamex()" id="button"></td>
		</tr>
	<form name="requisicao_transacao" action="Req_trans_processamento2.asp" method="post">
		<tr>
    ...
    <table align="center" width="576" cellspacing="5">
        ...
        <tr>
        	<td class="submenu" onMouseOver="this.className='menu_light';doTooltip(event,6.4)" onMouseOut="this.className='submenu';hideTip()">CVV2</td><td class="menu" colspan="2" id="dados_cartao4"><input id="dados_cartao41" type="text" name="dados_portador_codigo_seguranca" size="4" maxlength="4" /></td>
        </tr>
        <tr>
        ...
        <tr>
        	<td rowspan="7" align="center" class="menu" onMouseOver="this.className='menu_light';doTooltip(event,7)" onMouseOut="this.className='menu';hideTip()">DADOS-PEDIDO</td>
        ...
        <tr>
        	<td class="submenu" onMouseOver="this.className='menu_light';doTooltip(event,7.7)" onMouseOut="this.className='submenu';hideTip()">Soft Descriptor:</td><td class="menu" colspan="2"><input type="text" name="dados_pedido_softdescriptor" size="30" maxlength="13" /></td>
        </tr>
        <tr>
            ...
            <td class="submenugrande" onMouseOver="this.className='menu_light';doTooltip(event,8.1)" onMouseOut="this.className='submenugrande';hideTip()">Bandeira:</td><td align="center" class="menu" colspan="2"><br />
	<input type="radio" id="0" checked="checked" name="forma_pagamento_bandeira" value="visa" /><img src="Imagens/Visa_2.png" align="middle"/>
	<input type="radio" id="1" name="forma_pagamento_bandeira" value="mastercard" /><img src="Imagens/Mastercard_2.png" align="middle"/><br /><br />
	<input type="radio" id="2" name="forma_pagamento_bandeira" value="elo" /><img src="Imagens/Elo_2.png" align="middle"/>
	<input type="radio" id="3" name="forma_pagamento_bandeira" value="diners" /><img src="Imagens/Diners_2.png" align="middle"/><br /><br />
	<input type="radio" id="4" name="forma_pagamento_bandeira" value="discover" /><img src="Imagens/Discover_2.png" align="middle"/>
	<input type="radio" id="5" name="forma_pagamento_bandeira" value="amex" /><img src="Imagens/Amex_2.png" align="middle"/><br /><br /></td>
        </tr>
        <tr>
        ...
        <tr>
         ...
         <tr>
            ...
            <td class="submenugrande" onMouseOver="this.className='menu_light';doTooltip(event,10.1)" onMouseOut="this.className='submenugrande';hideTip()">Autorizar:</td><td class="menu" colspan="2"><input type="radio" name="autorizar" value="0" checked="checked"/>0 - Não Autorizar<br />
                                   ...
                                   <input type="radio" name="autorizar" value="3" />3 - Autorizar sem passar<br />pelo processo de autenticação<br />(somente para crédito)<br />
				   <input type="radio" name="autorizar" value="4" />4 - Renova Fácil<br />Transação recorrente</td>
         </tr>
         <tr>
         ...
         <tr>
         	<td height="50" colspan="4" align="center" class="topo"><input type="submit" value="Confirmar dados" OnClick="return valida11()"  id="button"/></td>
         </tr>
    </table>
	<br />
	</form>
