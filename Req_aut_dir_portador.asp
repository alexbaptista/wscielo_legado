...
<tr>
	...
	<table cellspacing="5" align="center" width="576">
		...
		<tr>
			<td rowspan="2" align="center" height="25"><img src="Imagens/Visa.png" align="middle"/></td>
			<td align="center" class="submenu"><input type="button" value="Autenticado" OnClick="preenche_cartao_AUTCARDvisa_2()" id="button"></td>
			<td rowspan="2" align="center"><img src="Imagens/Mastercard.png" align="middle"/></td>
		...
		<tr>
			<td rowspan="2" align="center"><img src="Imagens/Elo.png" align="middle"/></td>
		...
		<form name="requisicao_autorizacao_portador" action="Req_aut_dir_portador_processamento.asp" method="post">
		<tr>
	...
	<br />
		<table cellspacing="5" align="center" width="576">
			...
			<tr>
			 ...
			 <tr>
				<td height="50" colspan="4" align="center" class="topo" colspan="2"><input type="submit" value="Confirmar dados" OnClick="return valida7()" id="button"/></td>
			 </tr>
		</table>
	</form>
	<br />
