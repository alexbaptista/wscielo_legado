...
<%
Else
	mensagem = "<?xml version='1.0' encoding='ISO-8859-1'?><requisicao-consulta id='5' versao='1.1.0'><tid>" & Session("TEMPtid") & "</tid><dados-ec><numero>" & Session("TEMPnumero") & "</numero><chave>" & Session("TEMPchave") & "</chave></dados-ec></requisicao-consulta>"
